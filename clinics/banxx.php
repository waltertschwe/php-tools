...
$sql = "SELECT * from fertility.clinics WHERE is_ivf_advantage = ? OR is_egg_banxx = ?";
...
<div class="container">
    <div class="page-header">
    	<div class="container">
        <h3><a href="../">Data Dashboard</a> > Egg Banxx & IVF Clinics</h3>
        <p class="bubble">Actions: 
	        <a href="../csv/data/ivf-banxx-locations.csv"><span class="glyphicon glyphicon-file"></span></a>
	    </p>
    </div>
</div>
<div class="row">
				...
				<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $clinic['address_2']; ?></td>
