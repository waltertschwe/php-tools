...
$sql = "SELECT * from fertility.clinics WHERE is_eeva_test = ?";
...
<div class="container">
    <div class="page-header">
    	<div class="container">
        <h3><a href="../">Data Dashboard</a> > Eeva Test Clinics</h3>
         <p class="bubble">Actions: 
	        <a href="../csv/data/eeva-test-locations.csv"><span class="glyphicon glyphicon-file"></span></a>
	    </p>
    </div>
</div>
<div class="row">
